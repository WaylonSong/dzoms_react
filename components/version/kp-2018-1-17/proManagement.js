  ...
  render() {
    ...
    return (
      <div style={{marginBottom:50}}>
        ...
        <Table key={this.key++}  scroll={{ x: 1200}} bordered pagination={false} rowSelection={rowSelection} columns={columns} onChange={this.onChange.bind(this)}  dataSource={this.state.recData} />
      </div>
    );
  }
}
