    ...
    const columns = [
      {
        ...
        children: [{
           title:"个人",
           dataIndex:"personal",
           render:(text, record, index)=>(<TextArea  autosize={{ minRows: 2, maxRows: 6 }} onChange={this.onCompleteChange.bind(this,index)}/>)  
        },{
           title:"部门",
           dataIndex:"department", 
           render:(text, record, index)=>(<TextArea disabled={true} autosize={{ minRows: 2, maxRows: 6 }}/>)  
        },{
           title:"考评组",
           dataIndex:"kpGroup",
           render:(text, record, index)=>(<TextArea disabled={true} autosize={{ minRows: 2, maxRows: 6 }} />)  
        ...
        children: [{
           ...
           title:"部门",
           dataIndex:"bumen", 
           render:(text, record, index)=>(<InputNumber min={1} disabled={true}/>)  
        },{
           title:"考评组",
           dataIndex:"pfgroup",
           render:(text, record, index)=>(<InputNumber min={1}  disabled={true}/>)  
